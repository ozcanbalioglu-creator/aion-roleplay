    ...
    <main className="flex min-h-screen bg-background text-on-background overflow-hidden">
      ...
      <section className="hidden lg:flex flex-col justify-between w-1/2 bg-on-background p-16 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-2xl font-light tracking-tighter text-surface flex items-center gap-3">
            <span className="material-symbols-outlined text-on-primary-container" style={{ fontVariationSettings: "'FILL' 1" }}>auto_awesome</span>
            <span className="font-headline italic text-3xl">AION</span> MIRROR
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-16">
          ...
          <p className="mt-8 text-lg text-surface/60 font-body font-light leading-relaxed">
            Profesyonel gelişim yolculuğunda ICF yetkinliklerinizi derinlemesine analiz eden ve yansıtan entelektüel partneriniz.
          </p>
        </div>
      ...
      <section className="flex flex-col justify-center items-center w-full lg:w-1/2 p-8 md:p-24 bg-surface relative">
        ...
        <div className="lg:hidden absolute top-12 left-1/2 -translate-x-1/2">
          <div className="text-2xl font-light tracking-tighter text-on-background flex items-center gap-2">
            <span className="material-symbols-outlined text-on-primary-container">auto_awesome</span>
            <span className="font-headline italic">AION</span> MIRROR
          </div>
        </div>
